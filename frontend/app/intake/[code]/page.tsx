      ...
      <div className="w-full max-w-md">
        ...
        {error && (
          <div className="glass-card p-8 text-center">
            ...
            <h2 className="text-lg font-bold text-white mb-2">Link Not Found</h2>
          ...
          <div className="glass-card p-8">
            ...
            {info.is_admin ? (
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-blue-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-blue-500/25">
                  <GraduationCap size={30} className="text-blue-400" />
                </div>
                <h2 className="text-xl font-bold text-white mb-1">Find Your University</h2>
                <p className="text-slate-400 text-sm">Official student intake portal</p>
              </div>
            ) : (
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-indigo-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-indigo-500/25">

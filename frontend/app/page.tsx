...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Nav */}
      <nav className="border-b border-border bg-card/90 backdrop-blur-sm sticky top-0 z-50 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="font-black tracking-tight text-foreground text-base">Find Your Uni</span>
          </Link>

          {/* Desktop nav */}
          <div className="hidden md:flex items-center gap-4">
            <Link href="/universities" className="text-muted-foreground hover:text-foreground text-sm transition-colors font-medium">
              Universities
            </Link>
            ...
            <Link href="/auth/login/consultant" className="text-[#94A3B8] hover:text-muted-foreground text-xs transition-colors">
              Consultants
            </Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-border bg-card px-6 py-4 flex flex-col gap-4">
            <Link href="/universities" onClick={() => setMenuOpen(false)} className="text-secondary-foreground hover:text-foreground text-sm font-medium transition-colors">
              Universities
            </Link>
            <div className="flex gap-3 pt-1">
              <Link href="/auth/login" className="flex-1" onClick={() => setMenuOpen(false)}>
                <Button variant="outline" size="lg" className="w-full">{t("common.signIn")}</Button>
              </Link>
              <Link href="/auth/register/student" className="flex-1" onClick={() => setMenuOpen(false)}>
                <Button size="lg" className="w-full">{t("landing.getStarted")}</Button>
              </Link>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-28 pb-20 text-center relative">
        <div className="relative">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 font-normal leading-relaxed">
          ...
          <div className="relative mx-auto mt-16 max-w-5xl">
            ...
            <div className="relative rounded-xl border border-slate-200/50 bg-card shadow-2xl overflow-hidden">
              <Image
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto font-normal">Three steps. No fluff.</p>
        </div>
          ...
          {steps.map((step, i) => {
            ...
            return (
              <div key={i} className="glass-card glass-card-hover p-8 text-center relative">
                ...
                <h3 className="text-lg font-black tracking-tight text-foreground mb-2">{step.title}</h3>
        ...
        <div className="glass-card p-12">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8 font-normal leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <div className="glass-card p-5 border-[rgba(16,185,129,0.2)] hover:border-[rgba(16,185,129,0.3)] transition-colors">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="flex-1">
                    <div className="text-foreground font-black tracking-tight text-sm">University of Toronto</div>
                    <div className="text-muted-foreground text-xs font-medium">Canada · QS #21</div>
                  </div>
              ...
              <div className="glass-card p-5 hover:border-[#CBD5E1] transition-colors">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="flex-1">
                    <div className="text-foreground font-black tracking-tight text-sm">TU Munich</div>
                    <div className="text-muted-foreground text-xs font-medium">Germany · QS #37</div>
                  </div>
                  <div className="text-right">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="glass-card p-16 text-center border-[rgba(16,185,129,0.15)] relative overflow-hidden bg-[rgba(16,185,129,0.02)]">
          <div className="relative">
            <h2 className="text-4xl font-black tracking-tight text-foreground mb-4">Ready to find your program?</h2>
            <p className="text-muted-foreground mb-10 max-w-md mx-auto font-normal leading-relaxed">
      ...
      <footer className="border-t border-border py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-muted-foreground text-sm font-medium">Find Your Uni © 2026</span>
          </div>
          <div className="flex gap-6 text-sm text-muted-foreground">
            <Link href="/universities" className="hover:text-foreground transition-colors font-medium">Universities</Link>
            <Link href="/auth/login" className="hover:text-foreground transition-colors font-medium">Sign In</Link>
            <Link href="/auth/login/consultant" className="hover:text-foreground transition-colors font-medium">Consultants</Link>
          </div>
        </div>
      </footer>
    </div>

...
export default function ConsultantProfilePage() {
  ...
  const inputClass = "bg-slate-50 border-slate-200 text-foreground placeholder:text-muted-foreground focus:border-blue-500";
    ...
    >
      <GlassCard className="max-w-lg">
        <div className="space-y-5">
          ...
          <div>
            <Label className="text-muted-foreground mb-1.5 block">Role / Title</Label>
          ...
          <div>
            ...
            <p className="text-muted-foreground text-xs mt-1">Students will contact you via WhatsApp deep link.</p>
          </div>
        </div>
      </GlassCard>
    </PageWrapper>
